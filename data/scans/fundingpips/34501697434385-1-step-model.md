# 1 Step Model – FundingPips

*Source: [https://help.fundingpips.com/hc/en-us/articles/34501697434385-1-Step-Model](https://help.fundingpips.com/hc/en-us/articles/34501697434385-1-Step-Model)*

---
title: "1 Step Model – FundingPips"
source: https://help.fundingpips.com/hc/en-us/articles/34501697434385-1-Step-Model
date: 2026-06-12T16:16:50.539Z
---

1 Step Model

One phase. One goal. One Master Account.

Designed for traders who prefer a lean, performance-driven journey to their Master Account. By focusing on a single phase, we have streamlined the evaluation by removing the second hurdle, allowing you to reach your trading goals in record time.

- **One Evaluation Phase**: 10% profit target, minimum 3 trading days.
...
- **Risk Per Trade Idea applies on Master only**: does not apply during evaluation.
...
Once you successfully pass Phase 1, you will be offered the opportunity to trade on a Master Account. For setup instructions, [click here](/hc/en-us/articles/44390730743825-Get-Started#master).
...
Your equity or balance cannot fall 6% below the starting account size.
...
3% below $50K · 2% at $50K and above. Does not apply during evaluation.
...
This is the total amount you are not allowed to lose on your account overall. Your equity or balance cannot touch this level at any point, including floating losses from open trades.
...
A temporary change is in effect: holding trades over the weekend is currently **not allowed** on 1-Step Master Accounts. Ensure all trades are closed before market close on Friday. Any open trades will be automatically closed by the system; this is not a hard breach.
...
- **Related currency:** if a high-impact news event affects USD, you cannot open or close trades on USD-related pairs within the 10-minute window.
- **Trade opened 30 minutes before the event:** closing it within the 10-minute window will result in those profits not being counted.
...
No. There is no time limit to pass the evaluation. You can take as long as you need, as long as you complete at least one trade every 30 days to avoid inactivity and follow all trading rules.

When will I receive my Master Account after passing Phase 1?

After passing Phase 1, the Master Account is issued once the standard Master Account onboarding process is complete. This includes a manual review by the Responsible Trading Team (up to 2 working days), KYC verification, Customer Agreement signing, and connection to the risk management framework (a further 2 working days). Accounts $100K and above may require an additional review before the Master Account is issued.

If my open trades are showing a profit above the target, have I passed?

No. The profit target is only calculated on closed trades. Profits from trades that are still open do not count toward passing, even if they are showing a gain above the target. You need to close those trades for the profit to be counted.
...
Yes. The news window restriction on the Master Account applies to all order types, not just market orders. Opening or closing any position type within the restricted window on the affected currency will result in those profits not being counted.
...
Yes. If your Phase 1 account is breached due to trading rules or risk violations, a Reset option with a 10% discount will appear on your dashboard within 7 calendar days of the breach. Master Account breaches do not qualify for a reset.
...
Does the Risk Per Trade Idea rule apply during the evaluation phase?

No. The Risk Per Trade Idea rule only applies on the Master Account. It does not apply during the evaluation phase, so you will not be penalised for it while working toward your profit target.
